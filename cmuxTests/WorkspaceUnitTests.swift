...
final class KeyboardShortcutSettingsFileStoreTests: XCTestCase {
    ...
    func testSettingsFileStoreParsesPaneAppearanceSettings() throws {
        ...
        let previousBorder = defaults.object(forKey: app.paneBorderColorHex.userDefaultsKey)
        let previousActiveBorder = defaults.object(forKey: app.activePaneBorderColorHex.userDefaultsKey)
        let previousOpacity = defaults.object(forKey: app.unfocusedPaneOpacity.userDefaultsKey)
        let previousBackups = defaults.data(forKey: settingsFileBackupsDefaultsKey)
        defer {
            restoreUserDefault(previousBorder, key: app.paneBorderColorHex.userDefaultsKey)
            restoreUserDefault(previousActiveBorder, key: app.activePaneBorderColorHex.userDefaultsKey)
            restoreUserDefault(previousOpacity, key: app.unfocusedPaneOpacity.userDefaultsKey)
            if let previousBackups {
                defaults.set(previousBackups, forKey: settingsFileBackupsDefaultsKey)
            } else {
                defaults.removeObject(forKey: settingsFileBackupsDefaultsKey)
        ...
        defaults.removeObject(forKey: app.paneBorderColorHex.userDefaultsKey)
        defaults.removeObject(forKey: app.activePaneBorderColorHex.userDefaultsKey)
        defaults.removeObject(forKey: app.unfocusedPaneOpacity.userDefaultsKey)
        defaults.removeObject(forKey: settingsFileBackupsDefaultsKey)
